...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    private $listeRestaurant;

    public function __construct()
    {
        $this->listeCommandes = new ArrayCollection();
        $this->listeRestaurant = new ArrayCollection();
    }
    ...
    public function removeListeCommande(Commande $listeCommande): self
    {
        if ($this->listeCommandes->removeElement($listeCommande)) {
            ...
            if ($listeCommande->getUser() === $this) {
                $listeCommande->setUser(null);
            }
        }
     ...
     */
    public function getListeRestaurant(): Collection
    {
        return $this->listeRestaurant;
    }

    public function addListeRestaurant(Restaurant $listeRestaurant): self
    {
        if (!$this->listeRestaurant->contains($listeRestaurant)) {
    ...
    public function removeListeRestaurant(Restaurant $listeRestaurant): self
    {
        $this->listeRestaurant->removeElement($listeRestaurant);
